    ...
    <Card className="border-0 shadow-lg bg-white">
      <CardContent className="p-6 space-y-4">
        ...
        <div className="flex items-center justify-between pb-4 border-b">
          <h3 className="text-lg font-semibold text-slate-800">Independent Contractor Agreement</h3>
        ...
        <div className="text-xs text-slate-500 pt-4 border-t">
          <p>
            Agreement for: <strong>{contractorInfo.name || 'Contractor'}</strong> |
            Scope: <strong>{contractorInfo.scope}</strong> |
            Date: <strong>{contractorInfo.date}</strong>
          </p>
        </div>
      </CardContent>
    </Card>
