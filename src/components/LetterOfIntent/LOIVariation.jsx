...
export default function LOIVariation({
  variation,
  title,
  content,
  partyInfo,
      ...
      <CardContent className="p-6 space-y-4">
        ...
        {isEditing ? (
          <Textarea
            ...
            placeholder="Letter of Intent content..."
          />
        ) : (
        ...
        <div className="text-xs text-slate-500 pt-4 border-t">
          <p>
            Party: <strong>{partyInfo.partyName || 'Party'}</strong> |
            Context: <strong>{partyInfo.context}</strong> |
            Date: <strong>{partyInfo.date}</strong>
          </p>
        </div>
      </CardContent>
    </Card>
