...
export default function PartnershipVariation({
  variation,
  title,
  content,
  partnerInfo,
    ...
    <Card className="border-0 shadow-sm bg-white">
      <CardContent className="p-6 space-y-4">
        ...
        <div className="text-xs text-slate-500 pt-4 border-t">
          <p>
            Agreement for: <strong>{partnerInfo.name || 'Partner'}</strong> |
            Type: <strong>{partnerInfo.type}</strong> |
            Date: <strong>{partnerInfo.date}</strong>
          </p>
        </div>
      </CardContent>
    </Card>
