...
export default function TermsOfEngagementContent({
  content,
  engagementInfo,
  onUpdate,
  onExport,
    ...
    <Card className="border-0 shadow-lg bg-white">
      <CardContent className="p-6 space-y-4">
        ...
        <div className="flex items-center justify-between pb-4 border-b">
          <h3 className="text-lg font-semibold text-slate-800">Terms of Engagement</h3>
        ...
        {/* Engagement Info Footer */}
        <div className="text-xs text-slate-500 pt-4 border-t">
          <p>
            Client: <strong>{engagementInfo.clientName || 'Client'}</strong> |
            Type: <strong>{engagementInfo.engagementType}</strong> |
            Start Date: <strong>{engagementInfo.date}</strong>
          </p>
        </div>
      </CardContent>
    </Card>
