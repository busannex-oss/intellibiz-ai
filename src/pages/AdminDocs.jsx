...
const AGENTS = [
  ...
  },
  {
    ...
    description: 'The Brand Sentinel enforces absolute consistency of visual and verbal brand identity across every platform output — pages, documents, agent outputs, emails, and templates. It audits color usage, typography, logo placement, voice and tone, messaging hierarchy, and accessibility — then issues compliance reports with a 0-100% score.',
    responsibilities: [
      ...
      'Platform-specific standards: web, print/PDF, social media, video',
      'Compliance scoring with deduction model (wrong color -5, logo misuse -15, etc.)',
      'Issues compliance certificates and brand health reports',
    ],
    useCases: [
      'Review any page or document for brand compliance before publishing',
      'Validate AI-generated content (business plans, newsletters, pitches) against brand voice',
      'Run a platform-wide brand health audit',
      'Get a compliance score for any marketing material',
    ],
  ...
  },
  {
    ...
    status: 'active',
    clearance: 'All Users',
    tagline: 'Task creation, prioritization, and project milestone tracking.',
    description: 'The Project Manager AI Agent is the command center of the platform — the eyes and ears of every operation. It manages tasks and projects while simultaneously monitoring ALL other AI agents for activity, compliance, and consistency. Every 24 hours it issues a structured Daily Agent Activity Report flagging inactive, non-compliant, or inconsistent agent behavior.',
    responsibilities: [
      'Monitors ALL AI agent activity across the platform — flags inactive, non-compliant, or inconsistent agents',
      'Submits a Daily Agent Activity Report: active agents, inactive agents, compliance violations, coordination gaps',
      'Classifies agent issues by severity: CRITICAL / HIGH / MEDIUM / LOW with owner assignments',
      'Detects agents with zero activity when daily output is expected (e.g., Brand Audit, Graphic Artist)',
      'Flags cross-agent coordination failures (e.g., Brand Sentinel not reviewing Business Plan outputs)',
      'Creates and organizes tasks from business plan milestones',
      'Prioritizes tasks by impact and deadline',
      'Tracks project completion status and overall platform health',
      'Suggests next actions and escalates unresolved agent issues to Admin',
    ],
    useCases: [
      '"Run today\'s agent activity report — who is inactive?"',
      '"Which agents produced non-compliant outputs this week?"',
      '"Create a task list for launching my website"',
      '"Show me all overdue tasks across my projects"',
      '"Flag any agents that haven\'t run in the last 48 hours"',
    ],
    accessPath: 'Tasks page → Project Manager',
  },
];
