...
const AGENTS = [
  ...
  },
  {
    ...
    description: 'The Project Manager AI Agent helps users create, organize, and track tasks across their business projects. It can generate task lists from business plan milestones, prioritize work based on deadlines and impact, and provide project health status updates.',
    responsibilities: [
      'Creates and organizes tasks from business plan milestones',
      'Prioritizes tasks by impact and deadline',
      'Tracks completion status and project health',
      'Suggests next actions based on current project state',
      'Generates weekly task summaries and priority lists',
    ],
    useCases: [
      '"Create a task list for launching my website"',
      '"What should I work on next this week?"',
